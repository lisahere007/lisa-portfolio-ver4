...
const companies = [
  ...
  },
  {
    ...
    projects: [
      ...
      { id: 'a-vluxe', name: 'VLuxe', period: '2023~2024', tag: 'Ecommerce', desc_en: 'Luxury hair extension brand site', desc_kr: '럭셔리 헤어 익스텐션 브랜드 사이트', detail_en: 'Operated the VLuxe luxury hair extension brand site on WooCommerce with plugin management and QA.', detail_kr: 'VLuxe 럭셔리 헤어 익스텐션 브랜드 사이트 WooCommerce 운영. 플러그인 관리 및 QA를 수행했습니다.' },
      { id: 'a-madshade', name: 'Mad Shade', period: '2023~2024', tag: 'Ecommerce', desc_en: 'Hair color specialist brand site', desc_kr: '헤어 컬러 전문 브랜드 사이트', detail_en: 'Managed Mad Shade WooCommerce brand site operations including product updates and QA testing.', detail_kr: 'Mad Shade WooCommerce 브랜드 사이트 운영. 상품 업데이트 및 QA 테스트를 담당했습니다.' },
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        period: '2021~2023',
        tag: 'Ecommerce',
        desc_en: 'Luxury hair extension brand site',
        desc_kr: '럭셔리 헤어 익스텐션 브랜드 사이트',
        detail_en: 'Developed the VLuxe luxury hair extension brand site with premium product presentation and high-end UX layout.',
        detail_kr: 'VLuxe 럭셔리 헤어 익스텐션 브랜드 사이트 개발. 프리미엄 상품 프레젠테이션과 고급 UX 레이아웃을 구성했습니다.',
      },
      {
        id: 'c-madshade',
        name: 'Mad Shade',
        period: '2021~2023',
        tag: 'Ecommerce',
        desc_en: 'Hair color specialist brand site',
        desc_kr: '헤어 컬러 전문 브랜드 사이트',
        detail_en: 'Built the Mad Shade hair color brand site with shade filtering, product detail pages, and shade guide content.',
        detail_kr: 'Mad Shade 헤어 컬러 브랜드 사이트 구축. 색상 필터링, 상품 상세 페이지, 색상 가이드 콘텐츠를 구성했습니다.',
      },
      {
        id: 'c-kissgelpro',
        name: 'KISS Gel Pro',
      ...
      <div className="container">
        ...
        {tab === 'career' && (
          <div style={{ opacity: visible ? 1 : 0, transition: 'all 0.6s ease 0.2s' }}>
            <div className="company-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px' }}>
